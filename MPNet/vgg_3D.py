...
def model(net, keep_prob, training = True):
    ...
    net, w51, b51 = L.conv(net, name="conv5_1", kh=6, kw=1, n_out=512, training=True)
    net, w52, b52 = L.conv(net, name="conv5_2", kh=6, kw=1, n_out=512, training=True)
    ...
    # fully connected
    net, w6, b6 = L.fully_connected(net, name="fc6", n_out=64, training=True)
